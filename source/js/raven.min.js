    ...
    return function a(b, c, d) {
        ...
        1: [function (a, b, c) {
            ...
            (function (c) {
                ...
                var g = a(6), h = a(7), i = a(8), j = a(1), k = a(5), l = k.isError, m = k.isObject,
                    n = k.isPlainObject, o = k.isErrorEvent, p = k.isUndefined, q = k.isFunction, r = k.isString,
                    s = k.isArray, t = k.isEmptyObject, u = k.each, v = k.objectMerge, w = k.truncate,
                    x = k.objectFrozen, y = k.hasKey, z = k.joinRegExp, A = k.urlencode, B = k.uuid4,
                    C = k.htmlTreeAsString, D = k.isSameException, E = k.isSameStacktrace, F = k.parseUrl, G = k.fill,
                    H = k.supportsFetch, I = k.supportsReferrerPolicy, J = k.serializeKeysForMessage,
                    K = k.serializeException, L = k.sanitize, M = a(2).wrapMethod,
                    ...
                    Q = P.document, R = P.navigator;
                f.prototype = {
                    VERSION: "3.24.2", debug: !1, TraceKit: g, config: function (a, b) {
                        var c = this;
                        ...
                        this.z("debug", "Raven caught unhandled promise rejection:", a), this.captureException(a.reason, {extra: {unhandledPromiseRejection: !0}})
                    }, B: function () {
                        ...
                        if (b = v({trimHeadFrames: 0}, b ? b : {}), o(a) && a.error) a = a.error; else if (l(a)) a = a; else {
                        ...
                        var c = Object.keys(b).sort(), d = v(a, {
                        ...
                        if (!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(a)) {
                            ...
                            c.name = null;
                            var f = g.computeStackTrace(c), h = s(f.stack) && f.stack[1];
                            ...
                            if ((!this.k.ignoreUrls.test || !this.k.ignoreUrls.test(i)) && (!this.k.whitelistUrls.test || this.k.whitelistUrls.test(i))) {
                                if (this.k.stacktrace || b && b.stacktrace) {
                                    d.fingerprint = null == d.fingerprint ? a : d.fingerprint, b = v({trimHeadFrames: 0}, b), b.trimHeadFrames += 1;
                                    var j = this.X(f, b);
                        ...
                        var b = v({timestamp: d() / 1e3}, a);
                        if (q(this.k.breadcrumbCallback)) {
                            var c = this.k.breadcrumbCallback(b);
                            if (m(c) && !t(c)) b = c; else if (c === !1) return this
                        }
                        ...
                        if (Q) {
                            ...
                            var g = this.J(this.G(c)), h = Q.createElement("script");
                        ...
                        if (this.b) {
                            ...
                            if (Q.createEvent) Q.dispatchEvent(c); else try {
                        ...
                        var c = F(this.w.href), d = F(b), e = F(a);
                        ...
                        var f = P.chrome, g = f && f.app && f.app.runtime,
                        ...
                        if (!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(b) && !this.k.ignoreErrors.test(g)) {
                            ...
                            if (e && e.length ? (c = e[0].filename || c, e.reverse(), h = {frames: e}) : c && (h = {
                                ...
                                var i = v({exception: {values: [{type: a, value: b, stacktrace: h}]}, culprit: c}, f);
                                this.Y(i)
                            }
                        }
                    }, ha: function (a) {
                        ...
                        for (var b, c, d, e = ["to", "from", "url"], f = 0; f < a.values.length; ++f) if (c = a.values[f], c.hasOwnProperty("data") && m(c.data) && !x(c.data)) {
                            d = v({}, c.data);
                        ...
                        if (this.c || this.b) {
                            var a = {};
                            return this.c && R.userAgent && (a.headers = {"User-Agent": navigator.userAgent}), P.location && P.location.href && (a.url = P.location.href), this.b && Q.referrer && (a.headers || (a.headers = {}), a.headers.Referer = Q.referrer), a
                        }
                    }, y: function () {
            ...
            (function (c) {
                ...
                function r(a, b) {
                    var c, d;
                    if (g(a.length)) for (c in a) v(a, c) && b.call(null, c, a[c]); else if (d = a.length) for (c = 0; c < d; c++) b.call(null, c, a[c])
                }
                ...
                function u(a, b) {
                    ...
                    return "string" != typeof a || 0 === b ? a : a.length <= b ? a : a.substr(0, b) + "鈥�"
                }
                ...
                function B(a) {
                    ...
                    if (g.push(a.tagName.toLowerCase()), a.id && g.push("#" + a.id), b = a.className, b && j(b)) for (c = b.split(/\s+/), f = 0; f < c.length; f++) g.push("." + c[f]);
                ...
                function N(a, b) {
                    ...
                    for (var c = a.length; c > 0; c--) {
                        ...
                        if (!(d.length > b)) return c === a.length ? d : d + "鈥�"
                    }
                    return ""
                }
            ...
            (function (c) {
                ...
                f.report = function () {
                    ...
                    function l(a, b, c, g, h) {
                        ...
                        if (v) f.computeStackTrace.augmentStackTraceWithInitialElement(v, b, c, n), o(); else if (m && e.isError(m)) l = f.computeStackTrace(m), k(l, !0); else {
